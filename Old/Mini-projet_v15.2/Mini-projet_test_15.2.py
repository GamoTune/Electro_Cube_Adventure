...
######################################################################## L'édition
    ...
    fenetre_bouton.resizable(False,False)
    ...
    numeroNiveau = Label(fenetre_bouton, text=id_level, font="Arial, 40")
    numeroNiveau.pack(padx=103, pady=217)

    #boutonEditeurPoubelle = Button(fenetre_bouton, bd='1', image=imageBoutonSolo)
