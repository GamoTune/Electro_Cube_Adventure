...
def loadTestZone (event):
    ...
    with open("F:\\Programmes\\data\\level_test1.txt", "rb") as fichier:
    ...
    canevas.moveto(joueur,nombrePixel-1, nombrePixel-1)

def save_level (event):
    with open("F:\\Programmes\\data\\level_test1.txt", "wb") as fichierNiveau:
