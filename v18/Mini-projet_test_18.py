...
######################################################################## L'édition
    ...
    bouton_edit = Button(fenetre_bouton, image=imageWIP, bg='white', command=edit_bloc)
...
def menu_post_edition ():
    ...
    boutonExitEdit = Button(menuPostEdit, image=imageBoutonEditeurExit, command=retour_menu)
...
def menu_post_solo ():
    ...
    boutonExitSolo = Button(menuPostSolo, image=imageBoutonEditeurExit, command=retour_menu)
...
def retour_menu (event=0):
    global lienfichier, solo, fenetreinfosTest
    global edit
    global ligneX
    global ligneY
    global joueur
